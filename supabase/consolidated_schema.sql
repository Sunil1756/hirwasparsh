...
-- =========================================================================
-- MULTI-SOURCE FUSION ENGINE & ZERO GREENWASHING MRV TABLES
-- =========================================================================
...
CREATE TABLE IF NOT EXISTS public.satellite_overpasses (
  ...
  satellite_source TEXT NOT NULL DEFAULT 'copernicus_sentinel2_l2a',
...
CREATE TABLE IF NOT EXISTS public.confidence_scores (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  entity_type TEXT NOT NULL DEFAULT 'plot',
  entity_id UUID NOT NULL,
  plot_id UUID REFERENCES public.plots(id) ON DELETE CASCADE,
  total_score NUMERIC NOT NULL DEFAULT 0.0,
  satellite_signal_score NUMERIC NOT NULL DEFAULT 0.0,
  drone_signal_score NUMERIC NOT NULL DEFAULT 0.0,
  field_photo_score NUMERIC NOT NULL DEFAULT 0.0,
  time_decay_penalty NUMERIC NOT NULL DEFAULT 0.0,
  verification_tier TEXT NOT NULL DEFAULT 'unverified_demo',
