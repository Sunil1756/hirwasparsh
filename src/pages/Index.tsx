    ...
    <section className="py-24">
      <div className="container mx-auto px-4">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          <AnimatedCounter end={15420} label="Trees Planted" icon={<TreePine className="h-10 w-10" />} />
          <AnimatedCounter end={8530} suffix=" tons" label="CO₂ Absorbed" icon={<Leaf className="h-10 w-10" />} />
          <AnimatedCounter end={3250} label="Active Volunteers" icon={<Users className="h-10 w-10" />} />
          <AnimatedCounter end={48} label="Cities Participating" icon={<MapPin className="h-10 w-10" />} />
        </div>
      </div>
    </section>
